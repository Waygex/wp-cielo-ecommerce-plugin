...
/**
 * Cielo Credit Card Payment Gateway
 *
 * Handles all credit card payment logic for Cielo eCommerce 3.0
 *
...
class WC_Cielo_Credit_Card_Gateway extends WC_Payment_Gateway
{
    /**
     * Constructor
     */
    public function __construct()
    {
        ...
        $this->method_title = __('Cielo eCommerce 3.0 - Cartão de Crédito', 'cielo-ecommerce');
        ...
        if ($this->enable_debug) {
            $this->cielo_log('Cielo eCommerce 3.0 Credit Card Gateway iniciado com sucesso.');
        }
    }
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => __('Habilitar Cielo eCommerce - Cartão de Crédito', 'cielo-ecommerce'),
                'default' => 'yes'
            ),
            'title' => array(
    ...
    public function process_payment($order_id)
    {
        ...
        $body = $this->build_payment_request($order, $card_number, $card_holder, $expiry_month, $expiry_year, $card_cvc, $installments, $brand);
     ...
     * @return array
     */
    private function build_payment_request($order, $card_number, $card_holder, $expiry_month, $expiry_year, $card_cvc, $installments, $brand)
    {
        $body = array(
    ...
    private function cielo_log($message, $level = 'error')
    {
        ...
        $context = array('source' => 'cielo-ecommerce-credit-card');
